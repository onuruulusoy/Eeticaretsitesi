<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrunDetay.aspx.cs" Inherits="WebApplication1.UrunDetay" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="AnaSayfa.aspx">
                Zamazon
            </a>
        ...
        <div class="d-flex justify-content-center container mt-5">
            <div class="card p-3 bg-white">
                ...
                <div class="about-product text-center mt-2">
                    ...
                    <div>
                        <h2>
                            <asp:Label ID="Label7" runat="server" CssClass="auto-style5" Text='<%# Eval("urun_adi") %>'></asp:Label></h2>
                    </div>
                </div>
                <div class="stats mt-2">
                    <div class="d-flex justify-content-between p-price">
                        
                            <asp:Label ID="Label9" runat="server" Text="Fiyatı" CssClass="auto-style1"></asp:Label>
                            <span>
                        <asp:Label ID="Label8" runat="server" CssClass="auto-style6" Text='<%# Eval("urun_fiyat") %>' style="font-size: x-large"></asp:Label></span></div>
                </div>
                <div class="d-flex justify-content-between total font-weight-bold mt-4">
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="48px" ImageUrl="~/Images/sepeteekle.jpg" OnClick="ImageButton1_Click" Width="143px" />
